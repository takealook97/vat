...
type Workspace struct {
	...
	RemoteTemplate string `yaml:"remote_template,omitempty"`
...
type Policy struct {
	...
	Brain     BrainPolicy     `yaml:"brain"`
	Changeset ChangesetPolicy `yaml:"changeset"`
	Gates     GatePolicy      `yaml:"gates"`
}
...
type SyncPolicy struct {
	...
	AllowAutostash bool `yaml:"allow_autostash"`
	// AllowAutoPush must stay false: a local-ahead branch is a human decision.
	AllowAutoPush bool `yaml:"allow_auto_push"`
...
type GatePolicy struct {
	...
	ExternalWrite string `yaml:"external_write"`
	BrainPromote  string `yaml:"brain_promote"`
}
